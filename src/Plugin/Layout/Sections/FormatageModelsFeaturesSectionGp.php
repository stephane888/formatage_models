 ...
 *
 * @Layout(
 *   id = "formatage_models_features_section",
 *   label = @Translation(" Features section GP. "),
 *   category = @Translation(" Formatage Models "),
 *   path = "layouts/sections",
 *   template = "formatage-models-features-section",
 *   library = "formatage_models/formatage-models-features-section",
 ...
 * )
 */
class FormatageModelsFeaturesSectionGp extends FormatageModelsSection {
